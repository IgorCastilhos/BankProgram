...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		// Checa o saldo das contas
		fmt.Println(">> transações:", fromAccount.Balance, toAccount.Balance)
		...
		// Checa o saldo final atualizado
